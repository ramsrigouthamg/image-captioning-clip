...
model,tokenizer,conceptual_weight,clip_model,preprocess = load_model()
...
class ClipCaptionModel(nn.Module):
    ...
    def __init__(self, prefix_length: int, prefix_size: int = 512):
        ...
        self.gpt = GPT2LMHeadModel.from_pretrained('./GPT2model')
...
def inference(request):
    ...
    base64str = model_inputs.get('base64str', None)
#     if prompt == None:
#         return response.json({'message': "No prompt provided"})

    pil_image = base64str_to_PILImage(base64str)
    basewidth = 300
    ...
    generated_text_prefix = generate_beam(
        model, tokenizer, beam_size=1, embed=prefix_embed
    )[0]

    caption = {"caption": generated_text_prefix}
    
    
    
#     output = run_model(model,tokenizer,prompt)
#     response = {"output": output}
    return json_response(caption) # Do not edit - returning a dictionary as JSON is a required interface
